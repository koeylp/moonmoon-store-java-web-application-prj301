<%-- 
    ...
    Created on : Jun 29, 2022, 11:47:46 PM
    Author     : thekh
--%>
...
<html lang="en">
    ...
    <body>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><%= drink.getName()%></td>
                        <td><img src="img/product/<%=drink.getImage()%>" style="width: 200px;" alt="#" class="img-fluid"></td>
                        <td><%= drink.getPrice()%></td>
                        <td><%= drink.getCategory()%></td>
                        <td><%= drink.getQuantity()%></td>
                        <td> <a href="MainController?action=Load&productID=<%= drink.getProductID()%>"><i class="fa-solid fa-pen"></i></a></td>
                        <td> <a href="MainController?action=DeleteP&productID=<%= drink.getProductID()%>"><i class="fa-solid fa-trash-can"></i></a></td>
                    </tr>
                    <%
                            }
                        }
        ...
        <!-- Add New Product -->
        <div id="addEmployeeModal" class="modal fade" style="">
                    ...
                    <form>
                        ...
                        <div class="modal-body">					                           
                            ...
                            <div class="form-group">
                                ...
                                <select class="shipping_select" name="category" style="margin: auto;"> 
                                    <%
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="submit" class="btn btn-success" name="action" value="AddP">
                        </div>
                    </form>
                </div>
            </div>

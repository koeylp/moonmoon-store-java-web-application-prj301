<%-- 
    Document   : product_list_user
    Created on : Jun 27, 2022, 10:50:22 PM
    Author     : thekh
--%>
            ...
            <div class="search_input" id="search_input_box">
                <div class="container ">
                    <form class="d-flex justify-content-between search-inner" action="MainController">
                        <input type="text" name="search" value="<%= search%>" class="form-control" id="search_input" placeholder="Search Here">
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <form action="MainController">
                                        <div class="single_product_item text-center">
                                            ...
                                            <input type="hidden" name="role" value="US">
                                            <button type="submit" name="action" value="BuyP" class="btn_3" 

<%-- 
    Document   : index
    Created on : Jun 20, 2022, 7:50:37 AM
    Author     : thekh
--%>
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="MainController?action=Show&roleID=NT">Product</a>
                                    </li>
                    ...
                    <div class="col-md-5">
                        <div class="banner_text">
                            <div class="banner_text_iner">
                                ...
                                <a href="MainController?action=Show&roleID=NT" class="btn_1">shop now</a>
                            </div>
                        </div>
                    </div>
                </div>

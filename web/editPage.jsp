<%-- 
    Document   : editPage
    Created on : Jul 6, 2022, 10:06:45 AM
    Author     : thekh
--%>
...
<html lang="en">
    ...
    <body>
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <a class="navbar-brand" href="adminPage.jsp"> <img src="img/logo_moon1.png" alt="logo"> </a>
            ...
            <div class="search_input" id="search_input_box">
                <div class="container ">
                    <form class="d-flex justify-content-between search-inner" action="MainController">
                        ...
                        <input type="hidden" name="role" value="AD_MA">
                        <button type="submit" name="action" value="SearchP" class="btn"></button>
        ...
        <!-- Header part end-->
        <div class="container-xl" style="margin-bottom: 20%;">
                        ...
                        <form action="MainController">
                            ...
                            <div class="modal-body">					                                   
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="<%= drink.getName()%>" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Image</label>
                                    <input type="text" name="image" value="<%=drink.getImage()%>" class="form-control">                                       
                                </div>
                                
                                <div class="form-group">
                                    <label>Price</label>
                                    <input type="number" name="price" min="0" value="<%= drink.getPrice()%>" class="form-control" >
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="browser-default custom-select" name="category">
                                        ...
                                        %>
                                        <option class="dropdown-menu" selected="<%= drink.getCategory()%>" value="<%= drink.getCategory()%>"><%= category.getCategoryId()%></option>
                                        <%
                                                }
                                            }
                                        %>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" name="quantity" value="<%= drink.getQuantity()%>" class="form-control" required="">
                                    <input type="hidden" name="productID" value="<%= drink.getProductID()%>" class="form-control">
                                </div>
                            </div>
                            <div class="modal-footer">
                                <a href="MainController?action=Show&roleID=AD_MN" >Cancel</a>
                                <button type="submit" class="btn btn-info" name="action" value="EditP">Save</button>
                            </div>
                        </form>
                    </div>
                </div>

<%-- 
    ...
    Created on : Jun 29, 2022, 8:31:07 PM
    Author     : thekh
--%>
                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
                                            ...
                                            <a class="dropdown-item" href="MainController?action=Show_order&role=AD"> Order</a>
                                        </div>
                                    </li>
                    ...
                    <div class="col-md-8">
                        <div class="product_list">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-6 content">
                                    <div class="single_product_item text-center">
                                        ...
                                        <button type="submit" name="action" value="Login" class="btn_3" class="g-recaptcha"
                            ...
                            <div class="load_more_btn text-center">
                                <a href="#" id="loadMore" class="btn_3">Load More</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-lg-5">
                        <div class="feature_part_content">
                            <p>Seamlessly empower fully researched growth strategies and interoperable internal or âorganicâ sources. Credibly innovate granular internal or âorganicâ sources whereas high standards in web-readiness.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-8">
                            <div class="footer_menu">
                                <div class="footer_logo">
                                    <a href="adminPage.jsp"><img src="img/logo_moon1.png" alt="#"></a>
                                </div>
